% Power Model Diego Manzano No Mach


a1_P = 0.0274360495951507;
b1_P = 0.0415057866404749;
c1_P = -0.215182093076404;
d1_P = 0.155445137250961;
e1_P = -0.0100177928790687;

a2_P = -0.00244233735356219;
b2_P = 0.00276711267137919;
c2_P = 0.0340600619724721;
d2_P = -0.0962404299965117;

a3_P = -0.00127616307213121;
b3_P = 0.0497464162802541;
c3_P = 0.0854745578295837;

a4_P = -0.001989304036352;
b4_P = -0.0531350967588885; 

a5_P = 0.00317690614582657;
...
% Create title
title('CP Diego M. No Mach [-] vs. J [-] \& $\phi$ [deg]',"Interpreter","latex");
