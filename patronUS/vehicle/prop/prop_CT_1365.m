function T = prop_CT_1365(V, n , phi, params)

    persistent a1_T b1_T c1_T d1_T e1_T b2_T c2_T d2_T b3_T c3_T b4_T J_min J_max phi_min phi_max ;
    
    %% This section depends on the model itself. The coefficients, and validity ranges of the model.
    if isempty(a1_T)
