...
function CL_fuselage = CL_fuselage_2wing()
 import casadi.*

alpha_mesh = [-180, -170, -160, -150, -140, -130, -120, -110, -100, -90, ...
...
CL_interp = interpolant('CL_interp','bspline',{alpha_mesh},CL_fuselage_2wing_mesh);

% Symbolic translation using CASADI for OCP:

alpha = SX.sym('alpha');

CL_fuselage = CL_interp(alpha); 
