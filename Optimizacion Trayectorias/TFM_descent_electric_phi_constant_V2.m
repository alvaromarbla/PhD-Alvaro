...
x0_f = [20 5*pi/180 5*pi/180 5*pi/180 55];
...
c  = [-X(1);-X(2);X(2)-pi/2;T(X(1),X(5),X(3),X(4))-Tmax;phi(X(3),X(4))-pi/2;X(3)-pi/2;X(4)-pi/2;-CP(X(1),X(5),X(3),X(4));X(5)-rps_max;-X(5)];

% T = D condition
ceq = [T(X(1),X(5),X(3),X(4)).*cos(phi(X(3),X(4)))-0.5*rho*X(1).^2*S*CD(X(3))-W*sin(X(2)); T(X(1),X(5),X(3),X(4)).*sin(phi(X(3),X(4)))+0.5*rho*X(1).^2*S*CL(X(3))-W*cos(X(2))];
end
